...
export function registerDSL() {
    ...
    monaco.languages.setLanguageConfiguration('rail', {
        comments: {
            lineComment: "//",
            blockComment: ['/*', '*/']
        },
    ...
    monaco.languages.setMonarchTokensProvider('rail', <any>{
        // Set defaultToken to invalid to see what you do not tokenize yet
        // defaultToken: 'invalid',

        keywords: [
            'rail-map', 'with', 'tracks', 'from', 'to', 'in', 'segments', 'track'
        ],

        typeKeywords: [
            'station', 'connection', 'turnout'
        ],
